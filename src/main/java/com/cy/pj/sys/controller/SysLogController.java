...
import com.cy.pj.sys.service.impl.SysLogServiceImpl;
...
//	}//spring mvc 会借助jackson api将结果转换为json格式字符串
	//測試pageHelper
	@GetMapping("doFindPageObjects")
	public JsonResult doFindPageObjects(String username,Integer pageNum,Integer pageSize) throws JsonProcessingException {
		PageInfo<SysLog> pageInfo=sysLogService.pageHelperFindPageObjects(username, pageNum, pageSize);
